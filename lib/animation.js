...
class GAnimation extends EventTarget {
    ...
    ;
    removeAllContexts() {
        __classPrivateFieldGet(this, _GAnimation_contexts, "f").forEach(ctx => {
            this.removeContext(ctx);
        });
    }
    latestContext() {
        return __classPrivateFieldGet(this, _GAnimation_contexts, "f")[__classPrivateFieldGet(this, _GAnimation_contexts, "f").length - 1];
    }
